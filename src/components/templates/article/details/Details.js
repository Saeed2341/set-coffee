  ...
  return (
    <>
      ...
      <div className={styles.img_content}>
        <img
          src="https://set-coffee.com/wp-content/uploads/2024/01/cofffe.jpg"
          alt=""
        />
      ...
      <section>
        <p>
          <strong>ماریا پیکو-پرز، سرپرست تیم تحقیق</strong> از دانشگاه Jaume I ،
          در بیانیه‌ای درباره این یافته‌ها گفت : به عبارت ساده، شرکت کنندگان در
          این تحقیق بعد از نوشیدن قهوه برای انجام فعالیت هایشان آماده تر بودند و
          هوشیار آنها نسبت به محرک‌های خارجی بیشتر شده بود.
        </p>
        <p>
          این تحقیق برای بررسی اینکه آیا نوشیدن فنجان های قهوه بدون کافئین ممکن
          است نتایج مشابهی به همراه داشته باشد یا خیر طراحی نشده بود، اگرچه
          محققان این فرضیه را مطرح کردند که نوشیدنی های بدون قهوه که حاوی کافئین
          هستند احتمالاً تغییر وضعیت از حالت استراحت به انجام وظایف را سریعتر می
          کنند.
        </p>
        <p>
          پیکو پرز ادامه داد: «با در نظر گرفتن اینکه برخی از نتایج این تحقیق به
          علت وجود کافئین ایجاد می‌شوند، می‌توانیم انتظار داشته باشیم که سایر
          نوشیدنی‌های کافئین‌دار نیز اثرات مشابهی را به ایجاد کنند. با این حال،
          برخی از نتایج نیز فقط مختص نوشیدن قهوه بودند، که ناشی از عواملی مانند
          بو و طعم خاص این نوشیدنی، یا تاثیر روانی مرتبط با مصرف آن نوشیدنی بود.
        </p>
      </section> */}
